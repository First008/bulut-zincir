...
func main() {
	...
	resources := []opkit.CustomResource{ethereum.EthereumResource}
...
func createContext(kubeconfig string) (*opkit.Context, ethereumclient.BulutzincirV1alpha1Interface, error) {
