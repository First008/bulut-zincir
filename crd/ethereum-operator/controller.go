...
import (
	...
	opkit "bulutzincir"
	ethereum "bulutzincir/ethereum-operator/pkg/apis/bulutzincir/v1alpha1"
	ethereumclient "bulutzincir/ethereum-operator/pkg/client/clientset/versioned/typed/bulutzincir/v1alpha1"
...
func newEthereumController(context *opkit.Context, ethereumClientset ethereumclient.BulutzincirV1alpha1Interface) *EthereumController {
...
func (c *EthereumController) StartWatch(namespace string, stopCh chan struct{}) error {
	...
	watcher := opkit.NewWatcher(ethereum.EthereumResource, namespace, resourceHandlers, restClient)
