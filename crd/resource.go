...
func createCRD(context Context, resource CustomResource) error {
	...
	_, err := context.APIExtensionClientset.ApiextensionsV1beta1().CustomResourceDefinitions().Create(cntxt.TODO(), crd, metav1.CreateOptions{})
	if err != nil {
...
func waitForCRDInit(context Context, resource CustomResource) error {
	...
	return wait.Poll(context.Interval, context.Timeout, func() (bool, error) {
		crd, err := context.APIExtensionClientset.ApiextensionsV1beta1().CustomResourceDefinitions().Get(cntxt.TODO(), crdName, metav1.GetOptions{})
		if err != nil {
			return false, err
		}
