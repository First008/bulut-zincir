 Either follow the following readme instructions or just install the tools that specified in Docker/README.md and run the bash script which is inside the Docker folder.
